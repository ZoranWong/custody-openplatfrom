...
// 应用管理
const applicationsRoute: AppRouteRecord = {
...
// 用量统计
const usageStatsRoute: AppRouteRecord = {
...
// 账单管理
const billingRoute: AppRouteRecord = {
...
// 订阅管理
const subscriptionRoute: AppRouteRecord = {
...
// 账户管理
const accountRoute: AppRouteRecord = {
