...
<template>
  <div class="card p-6">
    <h3 class="text-lg font-semibold text-gray-900 mb-4">{{
      t('developer.billing.endpointBreakdown.title')
    }}</h3>
    ...
    <ElTable v-else :data="sortedEndpoints" stripe>
      <ElTableColumn :label="t('developer.billing.endpointBreakdown.path')" min-width="180">
        <template #default="{ row }">
          <span class="text-sm">{{ row.endpoint }}</span>
        </template>
      </ElTableColumn>
      <ElTableColumn
        :label="t('developer.billing.endpointBreakdown.calls')"
        width="100"
        align="right"
      >
        <template #default="{ row }">
      ...
      <ElTableColumn
        :label="t('developer.billing.endpointBreakdown.successCount')"
        width="100"
        align="right"
      >
        <template #default="{ row }">
      ...
      <ElTableColumn
        :label="t('developer.billing.endpointBreakdown.successRate')"
        width="90"
        align="right"
      >
        <template #default="{ row }">
      ...
      <ElTableColumn
        :label="t('developer.billing.endpointBreakdown.avgResponse')"
        width="110"
        align="right"
      >
        <template #default="{ row }">
      ...
      <ElTableColumn
        :label="t('developer.billing.endpointBreakdown.maxResponse')"
        width="110"
        align="right"
      >
        <template #default="{ row }">
