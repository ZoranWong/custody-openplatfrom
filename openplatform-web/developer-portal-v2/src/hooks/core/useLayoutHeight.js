...
export function useLayoutHeight(options = {}) {
 ...
 * ```
 */
export function useAutoLayoutHeight(headerIds = ['app-header', 'app-content-header'], options = {}) {
    const { extraSpacing = 15, updateCssVar = true, cssVarName = '--art-full-height' } = options;
    // 创建元素引用
    const headerRef = ref();
    const contentHeaderRef = ref();
...
//# sourceMappingURL=useLayoutHeight.js.map