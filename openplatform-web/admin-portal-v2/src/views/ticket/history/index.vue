<template>
  <div class="ticket-history-page art-full-height">
...
defineOptions({ name: 'TicketHistory' })

import { useTable } from '@/hooks/core/useTable'
import { fetchTickets, fetchTicketById } from '@/api/subscription'
...
const {
  ...
  core: {
    apiFn: (params: any) => {
      // Only fetch resolved/closed tickets for history view
      return fetchTickets({
        ...params,
